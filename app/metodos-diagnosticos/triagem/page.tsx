...
export default function TriagemPage() {
  ...
  const metodosTriagem = diagnosticos.filter(

    (metodo) =>

      metodo.finalidade.includes("Triagem")
        ...
        <section className="mx-auto max-w-[1200px] px-10 py-12">
          ...
          <div className="mb-10">
            ...
            <p className="mt-3 max-w-3xl text-gray-600">
              ...
              Métodos com alta sensibilidade utilizados inicialmente para
              identificar animais suspeitos e direcionar a investigação
              diagnóstica.
